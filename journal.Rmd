...
bikes_tbl      <- read_excel(path = "/Users/nikithakumar/Desktop/00_data/01_bike_sales/01_raw_data/bikes.xlsx")
orderlines_tbl <- read_excel("/Users/nikithakumar/Desktop/00_data/01_bike_sales/01_raw_data/orderlines.xlsx")

# Not necessary for this analysis, but for the sake of completeness
bikeshops_tbl  <- read_excel("/Users/nikithakumar/Desktop/00_data/01_bike_sales/01_raw_data/bikeshops.xlsx")
```
...
rosebike_model_names_tbl <- html_road_bike_category %>%
...
rosebike_model_names_tbl
rosebike_model_prices_tbl <- html_road_bike_category %>%
...
rosebike_model_prices_tbl

rosebike_catog_model_price_joined <- left_join(rosebike_model_names_tbl,rosebike_model_prices_tbl)

rosebike_catog_model_price_joined
```
The database should contain the model names and prices for at ROAD category. 

ANSWER
```{r echo=FALSE}
as_tibble(rosebike_catog_model_price_joined, .rows = 9)
```
# Challenge 3
...
patent_tbl <- vroom(
            file       = "/Users/nikithakumar/Desktop/00_data/04_patent/patent.tsv", 
            delim      = "\t", 
...
patent_assignee_tbl <- vroom(
            file       = "/Users/nikithakumar/Desktop/00_data/04_patent/patent_assignee.tsv", 
            delim      = "\t", 
...
assignee_tbl <- vroom(
            file       = "/Users/nikithakumar/Desktop/00_data/04_patent/assignee.tsv", 
            delim      = "\t", 
...
uspc_tbl <- vroom(
            file       = "/Users/nikithakumar/Desktop/00_data/04_patent/uspc.tsv", 
            delim      = "\t", 
...
ggplot(aes(x = date, y = total_cases, color = countriesAndTerritories)) +
  ...
  labs(title = "Covid19 confirmed cases worldwide",
       x = "Year 2020",
       y = "Cumulitive cases")
#covid_by_month_tbl+scale_color_manual(values=c("#999999", "#E69F00", #"#56B4E9", ))
